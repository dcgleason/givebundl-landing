...
const Messages = () => {
  ...
  const sendNoteCard = async ()=> {
    ...
    myHeaders.append("Authorization", "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsImp0aSI6IjhlNTM3YTFjMjlhMDg1NWNlNTM3MzcwZjRlN2E5Mjg0ZTUxZWRiOTlkZDNjMjVlMWE3YWZlNWQ1ZDM3ZjQwZGIwMmM4Yzc5MzZmNTRjMjVjIn0.eyJhdWQiOiIxIiwianRpIjoiOGU1MzdhMWMyOWEwODU1Y2U1MzczNzBmNGU3YTkyODRlNTFlZGI5OWRkM2MyNWUxYTdhZmU1ZDVkMzdmNDBkYjAyYzhjNzkzNmY1NGMyNWMiLCJpYXQiOjE2NjIxMzA0NDcsIm5iZiI6MTY2MjEzMDQ0NywiZXhwIjo0ODE3ODA0MDQ3LCJzdWIiOiIyMTc2MCIsInNjb3BlcyI6W119.cdRJckLJhH-DxGm6bx5_mM91NngsnzRTzOc2U7KjkIKFYS1zFBiP5TvC--CfpomAok9-ieZRLcwUCLAuCvoHNgxkNvSQTAa3x-1SnbFgVDiXbz4qdT4KLX-icC0f3WC334m_eEoQsTGIKLyXJYOz-7gcboktktg53h7LmOAJ6rjA73ElvUfMiogNUm6dZiyB5bvlJloMED7adqfmkpd1dnmCzYhyp3yjO4O-v3EfSYDb-XPYP7aSacSDchDwz9CVTiXMcyGnCpwHSef-s1KC1FR9LxyK7Ss16_pucUvV9IXCkhXZTlFBjRPeAdKZnNkdD0ZWZNKYgEHwD8Z03jUv4Wvd6muNXktkENUzNTmyVmjSdPZYUog46A9FK9S3RvlIgzh1W9kh9swm-CfzLQ7Oor9friHhPv3KfU39yj74NinUfv0lxh4ruJSlZlLGwC5cPwYFsR01vCZYFqXea8-m7SK_rDw_XXNvCPtbPXyG6L3nFuWql3o82_iKravv01pCzcR8hWcSFSNMhnsjlzN98UihdE2KPdBoUFDoW0wWp5ZLoi7mfFHaFOATiFqENN-smoUmSTdvSwlDUHPFBLEnoMOiux48OAIDbABlOj6YZ6abGUm9ha85Ml8sBwpJOOa6EoZkOafGHLbrF7SXKn6JB9UqUEnqyWIV6KAuk6tAwdg");
      ...
      <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
        <div>
          ...
          <div className="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
            ...
            <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
              <label htmlFor="username" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
              <em>Elle Young</em> just had a baby - her second. To show your support, please take this opportunity to tell her how much she means to you. How has she impacted you in positive ways? How and why are you grateful for her presence in your life? (please include a signature with your name at the end of your letter)
              </label>
              <div className="mt-1 sm:mt-0 sm:col-span-2">
                <div className="max-w-lg flex rounded-md shadow-sm">
                <textarea
