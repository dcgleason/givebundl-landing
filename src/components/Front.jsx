              ...
              {breadcrumbIdx !== product.breadcrumbs.length - 1 ? (
                ...
                <section aria-labelledby="information-heading" className="mt-4">
                  ...
                  <div className="mt-4 space-y-6">
                    <p className="text-base text-gray-500">Bundl book aka &rdquo;your secret weapon&rdquo;: <em> noun;</em> a physical book of prompt-driven messages from your team members to an individual, given for an event or an important employee milestone, that encourages, congratulates, and make that invidudal feel and know that they belong.</p> 
