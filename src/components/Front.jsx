              ...
              {breadcrumbIdx !== product.breadcrumbs.length - 1 ? (
                ...
                <section aria-labelledby="information-heading" className="mt-4">
                  ...
                  <div className="mt-4 space-y-6">
                    <p className="text-base text-gray-500">Bundl book <em>aka &rdquo;your secret weapon for boosting employee retention&rdquo;</em>: <em> noun;</em> a physical book of prompt-driven messages from your team members to an individual, given for an event or an important employee milestone, that encourages, congratulates, and make that invidudal feel and know that they belong.</p> 
...
{/* {uncomment this, and make stripe a non-test acconut to go live } */}
      ...
      <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
        Boost employee retention by instilling a felt sense of belonging into individuals.
      </h2>{" "}
