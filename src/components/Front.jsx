              ...
              {breadcrumbIdx !== product.breadcrumbs.length - 1 ? (
                ...
                <section aria-labelledby="information-heading" className="mt-4">
                  ...
                  <div className="mt-4 space-y-6">
                    <p className="text-base text-gray-500">According to <a href="https://www.surveymonkey.com/curiosity/employee-recognition-and-retention/"><em>this survey study</em></a>, regular employee regognition correlates directly to a 52% percent higher likelihood an employee will stay at his or her current job for the next three to six months. <br></br><br></br> Use Bundle to recognize great work, build community, promote core values and increase employee engagement.  <br/> <br/> Stay tuned! Enter your contact information into the form and get details when we launch! </p> 
