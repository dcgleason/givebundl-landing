              ...
              {breadcrumbIdx !== product.breadcrumbs.length - 1 ? (
                ...
                <section aria-labelledby="information-heading" className="mt-4">
                  ...
                  <div className="mt-4 space-y-6">
                    <p className="text-base text-gray-500">Bundle book: <em>noun, thoughtful gift</em>, a book and written letters and meaningful pictures provided by the recipient&apos;s friends and family meant to encourage, inspire, and remind the recipient of their best self.</p> 
