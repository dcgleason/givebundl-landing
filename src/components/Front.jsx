            ...
            <section aria-labelledby="details-heading">
              <div className="flex flex-col items-center text-center">
                <h2 id="details-heading" className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                  Here your Bundle is put together:
                </h2>
            ...
            <section aria-labelledby="policy-heading" className="mt-16 lg:mt-24">
              ...
              <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-3 lg:gap-x-8">
                ...
                <div>
                  ...
                  <p className="mt-3 text-base text-gray-500">A birthday is a great time to show an employee how much they mean to the organization and to their colleagues. Instead of a generic birthday card, have colleagues and management write messsages of support and appreciation to with that lucky employee a very happy birthday.</p>
                </div>
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-[#f8ad9d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <p className="mt-3 text-base text-gray-500">Simply the best way to recognize an employee and his or her work anniversary. Acknowledge the essential role they play for your team and thank them for all their contributions in the workplace. Happier staff equals higher employee productivity!</p>
                </div> 
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-[#f8ad9d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  ...
                  <p className="mt-3 text-base text-gray-500">Give a warm welcome to new team members with a Bundle form staff and employees -- introducing themselves and providing encouraging words. Onboarding Bundles enable you to walk new employees through the ins-and-outs of your organization from afar.</p>
                </div>
              ...
              <div>
                  ...
                  <p className="mt-3 text-base text-gray-500">Companies that give more employee recognition have higher productivity. Bring together a Bundle of written messages of appreciation and support from colleagues and all levels of managements. THis will lead to happier staff, boost morale, and create a stronger work culture and employee engagement.</p>
                </div>
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-[#f8ad9d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  ...
                  <p className="mt-3 text-base text-gray-500">SEasily collect farewell messages from coworkers and colleagues in a beautiful book keepsake. Farewell Bundles provide a lifetime of lasting memories for departing staff as they leave their role in the company. As they move on to new endeavors, they will have a treasured souvenir from the company.</p>
                </div>
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-[#f8ad9d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  ...
                  <p className="mt-3 text-base text-gray-500">Congratulate the retiree as they enter a new chapter in their life with a Bundle - it is a meaningful way to commemorate their lifetime of achievement and service. A personalized written Bundle from everyone is more sincere than a signed card. Send off the retiree with a memorable Bundle that they will cherish while enjoying their newfound freedom.</p>
                </div>
                {/* <div>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-[#f8ad9d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
