              ...
              {breadcrumbIdx !== product.breadcrumbs.length - 1 ? (
                ...
                <section aria-labelledby="information-heading" className="mt-4">
                  ...
                  <div className="mt-4 space-y-6">
                    <p className="text-base text-gray-500"><em>Stay tuned! Bundle uses its software to collect heartfelt messages of support, gratitude, and appreciation from the friends and family of a recipient and publishes them in a physical, bound, and aesthetically pleasing book for the person to keep. </em> <br/><br/> Enter your contact information into the form to pre-order your bundle now!</p> 
