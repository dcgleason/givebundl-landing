...
const product = {
  name: "Show someone how much they are loved.",
  href: '#',
  price: '$49',
  description:
   '',
              ...
              {breadcrumbIdx !== product.breadcrumbs.length - 1 ? (
                ...
                <section aria-labelledby="information-heading" className="mt-4">
                  ...
                  <div className="mt-4 space-y-6">
                    <p className="text-base text-gray-500"><em>Stay tuned! Bundle uses its software to collect and send heartfelt messages of support, gratitude, and appreciation from the friends and family of a recipient and publishes them in a physical, bound, and aesthetically pleasing book for the person to keep. </em> <br/><br/> Enter your contact information into the form to pre-order your bundle now!</p> 
                  ...
                  <div className="mt-6 text-center">
                    <a href="#" className="group inline-flex text-base font-medium">
                      <ShieldCheckIcon
                        ...
                        aria-hidden="true" />
                      <span className="text-gray-500 hover:text-gray-700">Tears of joy from your Bundle recipient, or your money back.</span>
                    </a>
                  </div>
