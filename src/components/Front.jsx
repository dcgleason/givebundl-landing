              ...
              {breadcrumbIdx !== product.breadcrumbs.length - 1 ? (
                ...
                <section aria-labelledby="information-heading" className="mt-4">
                  ...
                  <div className="mt-4 space-y-6">
                    <p className="text-base text-gray-500">According to <a href="https://www.surveymonkey.com/curiosity/employee-recognition-and-retention/"><em>this study</em></a>, an employee who is regularly recognized is 52% percent more likely to stay at his or her current job for the next three to six months. <br></br><br></br> Use Bundle to recognize great work, build community, promote core values and increase employee retention.  <br/> <br/> Stay tuned! Enter your contact information into the form and get details when we launch! </p> 
