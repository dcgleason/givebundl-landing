                ...
                <div className="overflow-hidden shadow sm:rounded-md">
                    ...
                    <div className="grid grid-cols-6 gap-6">
                        ...
                        <div className="mt-1 sm:mt-0 sm:col-span-2">
                            ...
                            rows={4}
                            required
                            placeholder="Hi Eliza, I am putting together some notes of gratitude for [recipient], because [reason]. I'd love it if you would contribute a few words of gratitude about [recipient]. Would you do that for me? Thank you, Dan"
