...
const [message, setMessage] = useState("Hi [Contributor], I am putting together some notes of gratitude for [Recipient] from his / her friends and family, because [reason]. I'd love it if you would contribute a few words of gratitude about [recipient]. Would you be willing to do that? The link to contribute is below. There will be prompts to help guide you! Thank you, [Your name]");
